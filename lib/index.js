			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					...
					connectors.map(function (connector) {
						...
						var splinestart = (0, _libUtil.computeOutOffsetByIndex)(fromNode.x, fromNode.y, _this3.computePinIndexfromLabel(fromNode.fields.out, connector.from));
						var splineend = (0, _libUtil.computeInOffsetByIndex)(toNode.x, toNode.y, _this3.computePinIndexfromLabel(toNode.fields['in'], connector.to));
